export default function Navbar() {
    return <footer className="col-12 position-sticky bottom-0 start-0 bg-light d-flex justify-content-evenly">
        ...
        <a href="https://www.linkedin.com/in/logan-mcdaniel-4850662a9">
            <button className="btn">
        ...
        <a href="https://stackoverflow.com/users/25278863">
            <button className="btn">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-stack-overflow" viewBox="0 0 20 20">
